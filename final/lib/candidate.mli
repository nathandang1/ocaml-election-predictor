...
val from_csv : bool
(** [from_csv] indicates whether a candidate can be extracted from a .csv file,
    and is [false].*)

val of_data : string list list -> t
(** [of_data data] is the candidate created using information extracted from the
    nested string list [data]. Requires that [data] contains a single list,
    whose first element is the name of the candidate, and whose second element
    is the name of the candidate's political party. *)
